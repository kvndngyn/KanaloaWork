...
get_filename_component(_filename "/kanaloa_vorc/src/kanaloa_pkg/srv/add_way_point.srv" NAME_WE)
add_custom_target(_way_point_wamv_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "way_point_wamv" "/kanaloa_vorc/src/kanaloa_pkg/srv/add_way_point.srv" ""
)

get_filename_component(_filename "/kanaloa_vorc/src/kanaloa_pkg/srv/way_point_cmd.srv" NAME_WE)
add_custom_target(_way_point_wamv_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "way_point_wamv" "/kanaloa_vorc/src/kanaloa_pkg/srv/way_point_cmd.srv" ""
)
